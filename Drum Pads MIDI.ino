...
unsigned long cymbalInterval = 10;
unsigned long previousCymbalMillis =0;
...
void loop() {
  ...
  if(cymbalValue >= CYMBALTHRESHOLD && noteReady(previousCymbalMillis, cymbalInterval))
  {
    previousCymbalMillis = millis();
    hitNote(cymbalValue, CYMBAL, 1, CYMBALTHRESHOLD);
  }
